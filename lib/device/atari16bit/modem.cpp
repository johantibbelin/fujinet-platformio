...
void ACSIModem::telnet_event_handler(telnet_t *telnet, telnet_event_t *ev)
{
    ...
    {
    case TELNET_EV_DATA:
        // if (ev->data.size && ACSI_send_buffer((uint8_t *)ev->data.buffer, ev->data.size) != ev->data.size)
...
*/
// void ACSIModem::ACSI_handle_stream()
// {
//     /**** AT command mode ****/
//     if (cmdMode == true)
//     {
...
//         // int sioBytesAvail = ACSI_recv_available();
...
//         //     // int sioBytesRead = ACSI_recv_buffer(&txBuf[0], //SIO_UART.readBytes(&txBuf[0],
...
//             else
//             {
//                 // ACSI_send_buffer(buf, bytesRead);
//                 // ACSI_flush();
//             }
